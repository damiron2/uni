...
public class FileWriter {
    ...
    public static void XLSXWriter(File file, List<Statistics> statisticsList) {
        try {
            ...
            log.debug("XLS Файл со статистикой записан" + " " + file);

            fileOutputStream.close();
        } catch (IOException e) {
            log.debug("Не удалось записать файл xls со статистикой" + " " + e);
        }
